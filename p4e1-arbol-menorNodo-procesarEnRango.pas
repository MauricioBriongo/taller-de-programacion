...
comprendidos entre los dos valores recibidos (sin incluir). }
  ...
  function ObtenerMontoTotalEntreDosCodigos (a: arbol; codigo1:integer; codigo2: integer): real;
  begin
    if (a = nil) then
      ...
      if (a^.dato.codigo > codigo1) then begin
        if (a^.dato.codigo < codigo2) then begin
          ObtenerMontoTotalEntreDosCodigos:= a^.dato.montoTotal + ObtenerMontoTotalEntreDosCodigos(a^.HD,codigo1,codigo2) + ObtenerMontoTotalEntreDosCodigos(a^.HI,codigo1,codigo2);
        end
        else
